...
**Вариант A:** в отдельный git-репозиторий переносится **целиком** каталог **`landing/`** и **`extension/`** (без вырезания SEO-листингов и остального Next-приложения исходного монорепо внутри `landing/`).
