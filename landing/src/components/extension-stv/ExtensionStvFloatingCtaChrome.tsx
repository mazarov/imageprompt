        ...
        <div className="flex justify-center">
          <div className="relative inline-flex overflow-hidden rounded-full p-[2.5px] shadow-[0_14px_48px_-14px_rgba(0,0,0,0.78)]">
            ...
            <a
              ...
              className={`pointer-events-auto relative z-[1] inline-flex min-h-11 items-center justify-center gap-2 rounded-full border border-white/[0.1] bg-[#09090b]/93 px-6 py-2.5 text-sm font-semibold text-zinc-100 backdrop-blur-md transition-colors duration-200 hover:border-white/[0.16] hover:bg-[#09090b]/96 ${STV_FOCUS_RING}`}
            >
